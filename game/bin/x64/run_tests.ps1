...
#   .\run_tests.ps1 -TestNames basic,harder           # Run specific tests
#   .\run_tests.ps1 -Group core                       # Run all tests in a group
#   .\run_tests.ps1 -TestNames basic -SkipVisualCheck # Skip screenshot comparisons
#   .\run_tests.ps1 -All -TimeoutExtensionMinutes 10  # Extend GPU timeout
...
elseif ($TestNames -and $TestNames.Count -gt 0) {
    ...
    Write-Host "Usage: run_tests.ps1 -All | -TestNames <name1>,<name2>,... | -Group <group>"
